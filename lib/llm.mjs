 ...
 */
export async function callClaude({ system, user, max_tokens = 8000 }) {
 ...
 */
export async function callClaudeJSON({ system, user, max_tokens = 8000 }) {
  const raw = await callClaude({ system, user, max_tokens });
  let text = raw.trim();
