...
- LEAD WITH THE MOST RECENT FIGURES. When the DATA gives values for several years, headline the latest one and frame the market as it stands now and where it is heading; mention older years only as history/trend. Do not open the report or the "Market size & growth" section with a base year that is two or more years old when a newer figure exists in the DATA.
